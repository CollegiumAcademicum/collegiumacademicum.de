...
Unfortunately, applications for July 2026 move-in are already closed.
The next possible move-in date is October 1, 2026.
You can apply for this starting from the beginning of July via the application form below. On request we can also accept applications for the following move-in, in such special cases please send us a short mail :). <!--
You can apply for this <b>until Sunday, May 3, 4 pm at the latest</b> via the application form here on our website. On request we can also accept applications for the following move-in, in such special cases please send us a short mail :). -->
