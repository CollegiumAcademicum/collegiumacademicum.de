...
<!-- Unfortunately, applications for April 2026 move-in are already closed. -->
The next possible move-in date is July 1, 2026.
<!-- You can apply for this starting from the end of April via the application form below. On request we can also accept applications for the following move-in, in such special cases please send us a short mail :). -->
