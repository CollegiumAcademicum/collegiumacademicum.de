...
<h3>Wohnung</h3>
<div class="field">
    <label class="label" for="apartment">Für welche Wohnung bewerbt ihr euch? (EG = Erdgeschoss, 1. OG = Erstes Obergeschoss) <a href="/mietwohnraum">Hier</a> geht's zur Übersicht.*</label>
	<div class="control">
        <div class="select">
