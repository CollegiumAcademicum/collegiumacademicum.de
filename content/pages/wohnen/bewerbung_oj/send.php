...
$fields = ['full_name', 'email', 'age', 'phone', 'doubleroom', 'mail', 'leitbild', 'selbstverwaltung',
'sonstiges', 'activity_in_ca', 'occupation', 'occupation_subject', 'pronouns',
'barrier_free', 'children', 'language_application_day', 'spam_protection', 'already_applied'];
...
$i18n = [
    "de" => [
        ...
        "application-sent" => "bewerbung-verschickt-oj",
