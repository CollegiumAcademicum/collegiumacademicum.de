...
$i18n = [
    "de" => [
        ...
        "mail-message" => "Vielen Dank für deine Anmeldung zur Führung!\nWir freuen uns, dass du teilnehmen möchtest. Mit dieser Nachricht bestätigen wir, dass Sie zur Führung angemeldet sind. Falls Sie Fragen zu der Führung haben oder sich wieder abmelden wollen, können Sie einfach auf diese E-Mail antworten.",
    ...
    "de" => [
        ...
        "mail-message" => "Thank you for registering for the guided tour!\nWe are happy that you would like to take part. With this message we confirm that you are registered. If you have any questions about the tour or would like to cancel, simply reply to this email.",
