...
Yes, we are still looking for many new residents for the move-in in in July 2022! So get to work and send us your application! We would also be happy if you told other people about us who might also be interested in moving in.
{{< /accordion >}}
...
No, right now we are focussing on finding the first residents that are moving in in July 2022. If you want to move in later, you should come back to us at a later time.
{{< /accordion >}}
...
As we are currently constructing the building, we can sadly not guarentee are precise fixed moving in date. Given our current plan, the moving-in day will in July 2022.
{{< /accordion >}}
