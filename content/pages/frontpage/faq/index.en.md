...
No, right now we are focussing on finding the first residents that are moving in in August 2022. If you want to move in later, you should come back to us at a later time.
{{< /accordion >}}
...
As we are currently constructing the building, we can sadly not guarentee are precise fixed moving in date. Given our current plan, the moving-in day will be in August 2022.
{{< /accordion >}}
